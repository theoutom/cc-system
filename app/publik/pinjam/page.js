      ...
      <div className="max-w-lg mx-auto px-4 py-6 space-y-5">
        ...
        <div className="bg-white rounded-2xl p-5 shadow-sm border border-slate-100 space-y-5">
          ...
          {step === 1 && <>
            ...
            <div>
              <label className="block text-sm font-semibold text-slate-700 mb-1.5">
                Email <span className="text-slate-400 font-normal">(opsional — untuk notifikasi status peminjaman)</span>
              </label>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-3.5 py-2.5 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-purple-500"
                />
              </div>
              <p className="text-xs text-slate-400 mt-1">📧 Admin CC akan menghubungi via email jika peminjaman disetujui/ditolak</p>
            </div>
